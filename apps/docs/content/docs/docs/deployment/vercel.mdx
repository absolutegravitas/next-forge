...
<SectionBlock
  title='Vercel Deployment Features'
  description='Key features and benefits of deploying with Vercel.'
  items={[
    {
      title: "Automatic Builds",
      description: "Vercel automatically builds your projects on every push.",
    },
    {
      title: "Preview Deployments",
      description: "Preview your changes before going live with preview URLs.",
    },
    {
      title: "Global CDN",
      description:
        "Your app is served from a global content delivery network for speed.",
    },
  ]}
/>
